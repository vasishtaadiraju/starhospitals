...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('homepage', function (Blueprint $table) {
            ...
            $table->string('banner1_description', 100)->nullable();
            ...
            $table->string('banner2_description', 100)->nullable();
            ...
            $table->string('banner3_description', 100)->nullable();
            ...
            $table->string('banner4_description', 100)->nullable();
