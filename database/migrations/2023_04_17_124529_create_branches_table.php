...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('branches', function (Blueprint $table) {
            ...
            $table->text('why_choose_us_card1_icon')->nullable();
            $table->string('why_choose_us_card1_title', 50)->nullable();
            $table->string('why_choose_us_card1_description', 120)->nullable();
            $table->text('why_choose_us_card2_icon')->nullable();
            $table->string('why_choose_us_card2_title', 50)->nullable();
            $table->string('why_choose_us_card2_description', 120)->nullable();
            $table->text('why_choose_us_card3_icon')->nullable();
            $table->string('why_choose_us_card3_title', 50)->nullable();
            $table->string('why_choose_us_card3_description', 120)->nullable();
            $table->text('why_choose_us_card4_icon')->nullable();
            $table->string('why_choose_us_card4_title', 50)->nullable();
            $table->string('why_choose_us_card4_description', 120)->nullable();
