<div class="ui-background">
    ...
    <div class="consultation">
                ...
                <ul class="consultation__card__contact-info__list">
                    ...
                    <li class="consultation__card__contact-info__list__item">
                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M19.6 8.15214L16.3998 2.61006L13.1997 4.45782V0.399902H6.80008V4.45782L3.59968 2.61006L0.4 8.15214L3.59968 9.9999L0.4 11.8474L3.59944 17.3897L6.79984 15.5422V19.5999H13.1997V15.5422L16.3998 17.3897L19.6 11.8474L16.3998 9.9999L19.6 8.15214ZM17.4143 12.4337L15.8145 15.2041L11.5998 12.7709V17.9998H8.39968V12.7709L4.18576 15.2041L2.58592 12.4337L6.80008 9.9999L2.58592 7.56702L4.18576 4.79526L8.39968 7.22886V1.99998H11.5998V7.22886L15.8145 4.79526L17.4143 7.56702L13.1997 9.9999L17.4143 12.4337Z" fill="white"/>
                            </svg>
                            

                        24*7 Emergency 
                        <ul>
                            <li><a href="tel:9100911911">Financial District - 9100911911
                                </a></li>
                            <li><a href="tel:8536953853">Banjara Hills - 8536953853</a></li>
                        </ul>
                    </li>
                    <li class="consultation__card__contact-info__list__item">
                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M10 20C4.47715 20 0 15.5228 0 10C0 4.47715 4.47715 0 10 0C15.5228 0 20 4.47715 20 10C20 15.5228 15.5228 20 10 20ZM10 18C14.4183 18 18 14.4183 18 10C18 5.58172 14.4183 2 10 2C5.58172 2 2 5.58172 2 10C2 14.4183 5.58172 18 10 18ZM11 10H15V12H9V5H11V10Z" fill="white"/>
                            </svg>
        ...
        <div class="consultation__form">
            <p class="consultation__form__title">Request a call back</p>
