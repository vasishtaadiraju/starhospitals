...
<div class="ui-background" >
            ...
            <p class="consultation__form__title">Please fill in your details</p>
             ...
             <form action="/request-callback" method="post">
                ...
                <div class="consultation__form__fields">
                    <input type="text" name="name" class=" @error('name') error-field @enderror" placeholder="Name">
                    {{-- <input type="text"> --}}
                </div>
                <div class="consultation__form__fields">
                    <input type="number" class=" @error('name') error-field @enderror" placeholder="Phone Number">
                    <input type="email" class=" @error('name') error-field @enderror" placeholder="Email">
                    <input type="email" class=" @error('name') error-field @enderror" placeholder="Email">
                </div>
                <div class="consultation__form__fields">
                    <select name="" id="">
    ...
    Lorem ipsum dolor sit amet consectetur adipisicing elit. Officiis laborum minima nulla, sequi eos odio, perspiciatis, maxime facilis assumenda architecto distinctio eaque nesciunt alias asperiores aliquam. Inventore a sunt alias?
