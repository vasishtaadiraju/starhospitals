<div class="int-enquiry-form">
        ...
        <div class="int-enquiry-form__content">
            ...
            <div class="int-enquiry-form__content__fields">
                ...
                <div class="form-input">
                    <select class="form-input__field int-enquiry-form__content__fields--country" placeholder="UK (+44)" type="text">
                ...
                <div class="form-input">
                    <select class="form-input__field form-input__field--w-1" placeholder="Country" type="text">
                        <optgroup label="Other countries">
                            <option class="country-code-selectbox-option" data-countrycode="AF" value="93-Afghanistan">
                              Afghanistan (+ 93)
                            </option>
