<div class="int-enquiry-form">
    <div class="int-enquiry-form__image">
        ...
        <p>If you have any further queries about the medical services or facilities we provide for our international
            patients, fill out the inquiry form to contact our medical staff for guidance.</p>
        ...
        <form action="/internationalPatientEnquiryForm" method="POST" enctype="multipart/form-data">
            ...
            <div class="int-enquiry-form__content__fields">
                <div class="form-input">
                    <input class="form-input__field form-input__field--w-1" name="name" placeholder="Full name"
                        type="text">
                </div>
                @error('name')
                ...
                @enderror
                <div class="form-input">
                    <select class="form-input__field int-enquiry-form__content__fields--country" name="country_code"
                        placeholder="UK (+44)" type="text">
                    ...
                    <input class="form-input__field int-enquiry-form__content__fields--contact" name="contact"
                ...
                <div class="form-input">
                    <input class="form-input__field form-input__field--w-1" name="email" placeholder="Email"
                        type="text">
                </div>
                @error('email')
                    <span class="error-message">{{ $message }}</span>
