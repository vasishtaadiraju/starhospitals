<div class="coes">
    <div class="coes__list">
        <h2 class="section-heading">Centers of Excellence</h2>
        <div class="coes__list__wrapper">
            <ul>
                ...
                @foreach ($coes as $item)
                    @if (count($item->specialities) > 0)
                        @foreach ($item->specialities as $speciality)
                            <div class="coes__list__item" data-type="speciality">
                        ...
                        @endforeach
                    @else
                        <div class="coes__list__item" data-type="coe">
