<div class="ui-background">
    ...
    <div class="doctors specialists-slider">
        <div class="doctors-card doctors-card--primary">
           <a href=""><img class="doctors-card--primary__doctor-img" src="{{Vite::asset('resources/images/doctors/Aneel Kumar.png')}}" alt=""></a> 
        ...
        <div class="doctors-card doctors-card--primary">
            <a href=""><img class="doctors-card--primary__doctor-img" class="doctors-card--primary__doctor-img" src="{{Vite::asset('resources/images/doctors/Aneel Kumar.png')}}" alt=""></a> 
