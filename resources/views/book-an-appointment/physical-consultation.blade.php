@extends('layout.main')
@section('css')
    @vite(['resources/scss/find-doctor.scss', 
        ...
        <div class="video-consultation__col-1">
            ...
            <div class="video-consultation__col-1__details-wrapper">
                ...
                <div class="video-consultation__col-1__details-wrapper__doctor-card">
                    <img data-src="{{ config('variables.asset') . $content->large_image }}"
                        alt="">
                    <div>
                        <h1 class="doctor-name">{{$content->name}}</h1>

                        <p class="video-consultation__col-1__designation">{{$content->designation}}</p>
                        <p class="video-consultation__col-1__specialty">
                    ...
                    @endforeach
                        ...
                        <p class="video-consultation__col-1__location">
                    ...
                    @endforeach
                        ...
                        <div class="d-p-info__btn-wrapper video-consultation__col-1__btn d-p-info__btn-wrapper video-consultation__col-1__btn--tab">
        ...
        <div class="video-consultation__col-2">
            ...
            <div class="video-consultation__col-2__form-wrapper ">
                ...
                <div class="form-fields">
                    ...
                    <div class="form-fields-wrapper form-fields-wrapper--col-1">
                        <div class="form-fields-wrapper ">
                            <select type="text" name="branch" class="pc-location-select-box" id="pc-location-select-box">
                                {{-- <option value=""> Location</option> --}}
                ...
                <div class="form-fields">
                    <div class="form-fields-wrapper form-fields-wrapper--col-1">
                        <div class="form-fields-wrapper ">
                            <select type="text" name="branch" class="pc-speciality-select-box" id="pc-speciality-select-box">
                                {{-- <option value="">Speciality</option> --}}
                ...
                <div class="form-fields">
                    <div class="form-fields-wrapper form-fields-wrapper--col-1">
                        <div class="form-fields-wrapper ">
                            <input type="text" name="doctor" data-csrf="{{ csrf_token() }}" class="pc-doctor-select-box"
                                data-name="{{$content->name}}" data-his-id="{{$content->his_id}}" placeholder="" value="{{$content->name}}" readonly>
                ...
                <div class="physical-consultation__dates-slider">
                    ...
                    @endphp
                    <div class="physical-consultation__dates @if ($i == 1)
                    physical-consultation__dates--active
                    @endif" data-date="{{$date}}" >
