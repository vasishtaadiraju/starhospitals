...
@section('content')
    ...
    {!! $breadcrum !!}
    <x-gap />
    <x-heading :title="'Book a Video Consultation'" :description="'Our healthcare specialists are equipped with the knowledge and skills to provide you with the support you require. From consultation to diagnosis to treatments, our experts are dedicated to helping you.'" />
    ...
    <div class="video-consultation">
        {{-- <div class="video-consultation__col-1">
            ...
            <div class="video-consultation__col-1__details-wrapper">
                ...
                <p class="video-consultation__col-1__designation">Consultant | Neurosurgery</p>
                ...
                <div class="d-p-info__btn-wrapper video-consultation__col-1__btn">
                    ...
                    <p class="d-p-info__btn-wrapper__btn d-p-info__btn-wrapper__btn--primary"> <span>40</span> Years of
                        Experience</p>
        ...
        <div class="video-consultation__col-2">
            <div class="video-consultation__col-2__form-wrapper">
                <form action="/videoConsultation" method="POST">
                    @csrf
